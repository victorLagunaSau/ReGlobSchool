...
export default function Documentacion({
  ...
  const handleContinue = async () => {
    ...
    const result = await handleAdvanceStage({
      ...
      currentStageNumber: 'Documentación',
  ...
  const handleBack = async () => {
    ...
    const result = await handleBackStage({
      leadId,
      previousStageClave: '103',
      currentStageTitle: stage?.titulo || 'Documentación',
      currentStageNumber: 'Documentación',
      notes,
    });
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-slate-500 mt-1">Tipo Documentación</p>
      </div>
